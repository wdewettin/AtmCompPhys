...
CLIM_TRG=${BASEDIR}/clim/BE40a_l_no_urban/Const.Clim.
CLIM_LBC=${BASEDIR}/clim/EUCO25/Const.Clim.
PGDFILE=${BASEDIR}/clim/BE40a_l_no_urban/PGD.fa
...
ln -sf $COUPLINGDIR/${YYYY}/${MM}/LBC_EUCO25_${YYYY}${MM}${DD}_${HH} ICMSHABOFINIT
