...
output_dir = f"/dodrio/scratch/projects/2022_200/project_output/RMIB-UGent/vsc45263_wout/CompPhys/runs/run_{run_name}_{rstart}_{nhours}/output" # The directory containing the FA-files
outputfilebase = "ICMSHABOF+" # The base of the FA-file names
fullpos_output_dir = f"/dodrio/scratch/projects/2022_200/project_output/RMIB-UGent/vsc45263_wout/CompPhys/runs/run_{run_name}_{rstart}_{nhours}/fullpos/output" # The directory containing the FA-files
fullpos_outputfilebase = "PFABOFABOF+" # The base of the FA-file names
store_dir = f"/dodrio/scratch/projects/2022_200/project_output/RMIB-UGent/vsc45263_wout/CompPhys/runs/run_{run_name}_{rstart}_{nhours}/store" # Directory to store the small netcdf-files with 2D output at single time steps
storefilebase = f"{run_name}_{rstart}_{nhours}" # The base of the name of the intermediate and final processed files
netcdf_dir = f"/dodrio/scratch/projects/2022_200/project_output/RMIB-UGent/vsc45263_wout/CompPhys/runs/run_{run_name}_{rstart}_{nhours}/netcdf" # Directory to store the combined raw model output in netcdf-format
cf_dir = f"/dodrio/scratch/projects/2022_200/project_output/RMIB-UGent/vsc45263_wout/CompPhys/runs/run_{run_name}_{rstart}_{nhours}/export" # Directory to store the final processed CF-compliant output
